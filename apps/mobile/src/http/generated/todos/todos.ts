...
export const getTodos = (
 ...
 signal?: AbortSignal
      ...
      {url: `http://192.168.104.65:3333/todos`, method: 'GET', signal
    },
      );
    }
...
export const getGetTodosQueryKey = () => {
    return [`http://192.168.104.65:3333/todos`] as const;
    }
...
export const postTodos = (
 ...
 signal?: AbortSignal
      ...
      {url: `http://192.168.104.65:3333/todos`, method: 'POST',
...
const {mutation: mutationOptions} = options ?? {};
 ...
 signal?: AbortSignal
      ...
      {url: `http://192.168.104.65:3333/todos/${id}`, method: 'GET', signal
    },
      );
    }
...
export const getGetTodosIdQueryKey = (id: string,) => {
    return [`http://192.168.104.65:3333/todos/${id}`] as const;
    }
...
export const patchTodosId = (
    ...
    patchTodosIdBody: PatchTodosIdBody,
      ...
      {url: `http://192.168.104.65:3333/todos/${id}`, method: 'PATCH',
      headers: {'Content-Type': 'application/json', },
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    putTodosIdBody: PutTodosIdBody,
      ...
      {url: `http://192.168.104.65:3333/todos/${id}`, method: 'PUT',
      headers: {'Content-Type': 'application/json', },
      data: putTodosIdBody
    },
      );
...
const {mutation: mutationOptions} = options ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    id: string,
      ...
      {url: `http://192.168.104.65:3333/todos/${id}`, method: 'DELETE'
    },
      );
    }
